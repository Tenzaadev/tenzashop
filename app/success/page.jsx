    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-[#ccff00]/5 to-yellow-500/5 border-2 border-[#ccff00]/20 rounded-3xl p-6 mb-4"
        >
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-white">
                {order?.paymentMethod === 'coins' ? <>🪙 {lang.paidWithCoins}</> : order?.paymentMethod === 'combined' ? '🪙 + 💳' : '💳 Sberbank QR'}
              </span>
            </div>
            {order?.coinsUsed > 0 && (
              <div className="flex justify-between">
